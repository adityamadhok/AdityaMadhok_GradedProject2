...
let choice = prompt('search resume type');

for (const cand in resume) {
	if (choice == resume[cand].basics.AppliedFor) {



		document.getElementById('top').innerText = resume[cand].basics.name;
		document.getElementById('A-F').innerText = "Applied For : " + resume[cand].basics.AppliedFor;


		for (const entries in resume[cand].basics) {
	
			let vv = document.getElementById('P-I')
			let nElement = document.createElement('p');
			let ntextNode = document.createTextNode(resume[cand].basics[entries]);
			nElement.appendChild(ntextNode);
			vv.appendChild(nElement);
		}


  
		for (const entries in resume[cand].skills.keywords) {
			let vv = document.getElementById('T-S')
			let nElement = document.createElement('p');
			let ntextNode = document.createTextNode(resume[cand].skills.keywords[entries]);
			nElement.appendChild(ntextNode);
			vv.appendChild(nElement);
			//console.log(resume[cand].skills.keywords[entries]);
		}


		for (const entries in resume[cand].interests) {
			let vv = document.getElementById('H')
			let nElement = document.createElement('p');
			let ntextNode = document.createTextNode(resume[cand].interests[entries]);
			nElement.appendChild(ntextNode);
			vv.appendChild(nElement);
		}

		for (const entries in resume[cand].work) {
			let vv = document.getElementById('WE')
			let nElement = document.createElement('p');
			let ntextNode = document.createTextNode(resume[cand].work[entries]);
			nElement.appendChild(ntextNode);
			vv.appendChild(nElement);
		}

		for (const entries in resume[cand].projects) {
			let vv = document.getElementById('Proj')
			let nElement = document.createElement('p');
			let ntextNode = document.createTextNode(resume[cand].projects[entries]);
			nElement.appendChild(ntextNode);
			vv.appendChild(nElement);
		}


		for (const entries in resume[cand].education) {
			let vv = document.getElementById('Edu')
			let nElement = document.createElement('p');
			let ntextNode = document.createTextNode(resume[cand].education[entries]);
			nElement.appendChild(ntextNode);
			vv.appendChild(nElement);
		}


		for (const entries in resume[cand].Internship) {
			let vv = document.getElementById('Int')
			let nElement = document.createElement('p');
			let ntextNode = document.createTextNode(resume[cand].Internship[entries]);
			nElement.appendChild(ntextNode);
			vv.appendChild(nElement);
		}


		for (const entries in resume[cand].achievements) {
			let vv = document.getElementById('Ach')
			let nElement = document.createElement('p');
			let ntextNode = document.createTextNode(resume[cand].achievements[entries]);
			nElement.appendChild(ntextNode);
			vv.appendChild(nElement);
		}
